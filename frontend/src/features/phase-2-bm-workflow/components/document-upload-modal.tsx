...
import { useUploadDocumentGdrive } from '../hooks/use-upload-document-gdrive';
...
export function DocumentUploadModal({ isOpen, onClose }: DocumentUploadModalProps) {
  ...
  const uploadMutation = useUploadDocumentGdrive();
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            branch Google Drive and versioned automatically.
          </DialogDescription>
        </DialogHeader>
          ...
          >
            ...
            {isSuccess ? (
              <div className="flex flex-col items-center gap-2 text-green-600">
                ...
                <p className="font-semibold">Uploaded to Google Drive!</p>
              </div>
            ) : file ? (
